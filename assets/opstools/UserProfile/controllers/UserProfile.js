            ...
            .then(function() {
               ...
               AD.Control.OpsTool.extend("UserProfile", {
                  ...
                  loadData: function() {
                     ...
                     var $sendEmailNotifications = self.element.find(
                        "input[name='sendEmailNotifications']"
                     );
                     var $profileImage = self.element.find(
                        "#profile-image-show"
                     );
                     var $profileImagePlaceHolder = self.element.find(
                        "#profile-image-placeholder"
                     );
                     var $previewProfileImage = self.element.find(
                     ...
                     AD.comm.service
                        ...
                        .fail(function(err) {
                           ...
                           console.error(
                              "::: UserProfile.loadData() : error gathering /site/user/data : ",
                              err
                           );
                        })
                        .done(function(data) {
                           ...
                           $sendEmailNotifications[0].checked =
                              data.user.sendEmailNotifications;
                           if (data.user.image_id) {
                              $profileImagePlaceHolder.hide();
                              $profileImage.show();
                              $profileImage[0].src =
                                 "/opsportal/image/UserProfile/" +
                                 data.user.image_id;
                              $previewProfileImage[0].src =
                                 "/opsportal/image/UserProfile/" +
                                 data.user.image_id;
                  ...
                  resize: function(data) {
                     ...
                     if (data && data.height) {
                        ...
                        console.warn(
                           "UserProfile.resize(): called without a valid data.height provided."
                        );
                     }
                  },
                  ...
                  "input[name='sendEmailNotifications'] click": function(
                     $el,
                     ev
                  ) {
                  ...
                  ".profile-image-input change": function($el, ev) {
                     ...
                     this.element
                        .find("form.profile-image button")
                        .prop("disabled", false);
                  },
                  ...
                  "form.profile-image button click": function($el, ev) {
                     ...
                     AD.comm.service
                        ...
                        .done(function(result) {
                           ...
                           $profileImage.show();
                           $profileImage[0].src =
                              "/opsportal/image/UserProfile/" + result.uuid;
                           $userIcon.siblings().hide();
                           $userIcon.show();
                           $userIcon[0].src =
                              "/opsportal/image/UserProfile/" + result.uuid;
