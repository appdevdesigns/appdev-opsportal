   ...
   command: function(builder, cb) {
      ...
      async.series(
         [
            ...
            function(next) {
               backUpName = builder.backupProduction({
                  base: "OpsPortal",
                  file: "production.js"
               });
               backUpCSS = builder.backupProduction({
                  base: "OpsPortal",
                  file: "production.css"
               });
            ...
            function(next) {
               ...
               transform(
                  ...
                  .then(function(transform) {
                     ...
                     fs.writeFile(
                        path.join("opstools", "OPNavEdit", "production.js"),
                        main.code,
                        "utf8",
                        function(err) {
                           if (err) {
                              AD.log.error(
                                 "<red>could not write minified opstools/OPNavEdit JS file !</red>"
                              );
                              next(err);
                           }
                  ...
                  .catch(function(err) {
                     AD.log.error(
                        "<red>could not complete opstools/OPNavEdit JS build!</red>",
                        err
                     );
                     next(err);
                  });
            ...
            function(next) {
               ...
               transform(
                  ...
                  .then(function(transform) {
                     ...
                     fs.writeFile(
                        path.join("opstools", "OPNavEdit", "production.css"),
                        main.code,
                        "utf8",
                        function(err) {
                           if (err) {
                              AD.log.error(
                                 "<red>could not write minified opstools/OPNavEdit CSS file !</red>"
                              );
                              next(err);
                           }
                  ...
                  .catch(function(err) {
                     AD.log.error(
                        "<red>could not complete opstools/OPNavEdit CSS build!</red>",
                        err
                     );
                     next(err);
                  });
            ...
            function(next) {
               var patches = [
                  {
                     file: path.join("opstools", "OPNavEdit", "production.js"),
                     tag: "packages/OpsPortal-OPNavEdit.js",
                     replace: "OpsPortal/production.js"
                  }
               ];
