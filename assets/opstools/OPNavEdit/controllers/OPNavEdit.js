            ...
            .then(function() {
               ...
               AD.Control.OpsTool.extend("OPNavEdit", {
                  init: function(element, options) {
                     ...
                     this.resizeID = AD.comm.hub.subscribe(
                        "opsportal.resize",
                        function(key, data) {
                           if (_this.element) {
                              _this.resize(data);
                     ...
                     AD.comm.socket.subscribe(
                        "opsportal_navigation_editor_stale",
                     ...
                     AD.comm.socket.subscribe("opconfigtool.created", function(
                        message,
                        data
                     ) {
                        // make sure we have a model instance of that tool in our Hash:
                        if (!_this.data.hashTools[data.data.id]) {
                           var Tool = AD.Model.get(
                              "opsportal.navigation.OPConfigTool"
                           );
                  ...
                  initAreaPopups: function() {
                     ...
                     function createAreaPopup(options) {
                        ...
                        $icon
                           .popover({
                              ...
                              html: true,
                              content: function() {
                                 return _this.renderer.popupArea({
                                    area: area,
                                    isAdd: isAdd
                                 });
                              }
                           ...
                           .on("shown.bs.popover", function(e) {
                                 ...
                                 if (form.isValid()) {
                                    ...
                                    area
                                       ...
                                       .fail(function(err) {
                                          ...
                                          busySave.ready();
                                          AD.error.log("Error saving Area", {
                                             error: err
                                          });
                                       })
                              ...
                              var buttonDelete = $cur_pop.find(
                                 ".op-nav-button-del"
                              );
                              var busyDelete = new AD.op.ButtonBusy(
                                 buttonDelete
                              );
                              buttonDelete.click(function() {
                                 ...
                                 area
                                    ...
                                    .fail(function(err) {
                                       busyDelete.ready();
                                       AD.error.log("Error destroying Area", {
                                          error: err
                                       });
                                    })
                                    .then(function() {
                     ...
                     this.dom.area
                        .find(".op-navbar-item-edit:not([op-navbar-init])")
                        .each(function(indx, icon) {
                           createAreaPopup({
                              elIcon: icon
                           });
                        });
                     ...
                     this.dom.area
                        .find(".op-navbar-add:not([op-navbar-init])")
                     ...
                     function createToolPopup(options) {
                        ...
                        $icon
                           .popover({
                              ...
                              html: true,
                              content: function() {
                                 return _this.renderer.popupTool({
                                    tool: tool,
                                    isAdd: isAdd
                                 });
                              }
                           ...
                           .on("shown.bs.popover", function(e) {
                              ...
                              buttonSave.click(function() {
                                 if (form.isValid()) {
                                    ...
                                    if (isAdd) {
                                       values.weight =
                                          _this.selectedArea.tools.length;
                                    }

                                    if (
                                       typeof values.isDefault == "undefined"
                                    ) {
                                    ...
                                    tool
                                       ...
                                       .fail(function(err) {
                                          busySave.ready();
                                          AD.error.log("Error saving Tool", {
                                             error: err
                                          });
                                       })
                                       .then(function(updatedTool) {
                                          if (isAdd) {
                                             ...
                                             var areaTools = _this.selectedArea.attr(
                                                "tools"
                                             );
                              ...
                              buttonDelete.click(function() {
                                 ...
                                 tool
                                    ...
                                    .fail(function(err) {
                                       busyDelete.ready();
                                       AD.error.log("Error destroying Tool", {
                                          error: err
                                       });
                                    })
                                    .then(function() {
                  ...
                  initDOM: function() {
                     ...
                     this.renderer = {};
                     this.renderer.popupArea = can.view.render(
                        this.options.templateDOMAreaForm
                     );
                     this.renderer.popupTool = can.view.render(
                        this.options.templateDOMToolForm
                     );

                     var menuFooter = $(
                        this.element.find("#op-menu-widget .op-widget-footer")
                     );
                     menuFooter.prepend(
                        [
                     ...
                     var dfdAreas = this.loadAreas()
                        ...
                        .then(function(Areas) {
                           ...
                           can.view(
                              _this.options.templateDOMAreas,
                              { areas: Areas },
                              function(frag) {
                                 _this.element.find(".op-stage").append(frag);
                                 _this.dom.area = _this.element.find(
                                    ".op-navbar-lpanel"
                                 );
                     ...
                     var dfdTools = this.loadTools().fail(function(err) {
                        AD.error.log("Error loading OPNavEdit.Tools ", err);
                     });

                     var dfdToolDefs = this.loadToolDefs().fail(function(err) {
                        AD.error.log(
                           "Error loading OPNavEdit.ToolDefinitions ",
                           err
                        );
                     });

                     $.when(dfdAreas, dfdTools, dfdToolDefs).done(function(
                        Areas,
                        Tools,
                        ToolDefs
                     ) {
                        ...
                        can.view(
                           _this.options.templateDOMTools,
                           {
                              areas: _this.data.listAreas,
                              hashTools: _this.data.hashTools,
                              toolDefs: ToolDefs
                           },
                           function(frag) {
                              _this.element
                                 .find("#op-masthead-sublinks")
                                 .after(frag);
                              _this.dom.tools = _this.element.find(
                                 "#op-navbar-edittools"
                              );
                              _this.dom.tools.hide();
                              // _this.dom.tools.append('<')

                              var busyIcon = _this.element.find(
                                 ".ops-navbar-toolspinner"
                              );
                              var busyToolAdd = new AD.op.ButtonBusy(
                                 busyIcon.parent()
                              );

                              var select = _this.dom.tools.find(
                                 ".ops-navbar-tooldeflist"
                              );
                              var defaultOption = new Option(
                                 AD.lang.label.getLabel(
                                    "opnavedit.AddNewTool"
                                 ) || "Add New Tool",
                                 "add.new.tool"
                              );
                              ...
                              select.on("change", function(ev) {
                                 ...
                                 if (_this.selectedArea) {
                                    ...
                                    AD.comm.service
                                       .post({
                                          url: "/opnavedit/newtool",
                                          params: {
                                             toolDef: keyToolDef,
                                             area: _this.selectedArea.key
                                          }
                                       })
                                       .fail(function(err) {
                                          busyToolAdd.ready();
                                          AD.error.log(
                                             "Error created OPNavEdit.newTool",
                                             { error: err }
                                          );
                                       })
                     ...
                     this.dom.subLinks = this.element.find(
                        "#op-masthead-sublinks"
                     );
                  ...
                  sortList: function(el, axis, objKey, cursor) {
                     var $list = $(el);
                     $list.sortable({
                        revert: true,
                        handle: ".sort-handle",
                        ...
                        start: function(ev, ui) {
                           ...
                           if (objKey == "tool") {
                              $(ui.item[0]).css(
                                 "width",
                                 ui.item[0].clientWidth + 2 + "px"
                              );
                              $(ui.item[0]).css("height", "32px");
                           }
                        },
                        update: function(event, ui) {
                           var start_pos = ui.item.data("start_pos");
                  ...
                  initSortArea: function() {
                     ...
                     this.dom.area
                        .find(".sortableMenu")
                        .each(function(indx, el) {
                           _this.sortList(el, "y", "area", "ns-resize");
                        });
                  },
                  ...
                  initSortTools: function() {
                     ...
                     this.dom.tools
                        .find(".sortableMenu")
                        .each(function(indx, el) {
                           _this.sortList(el, "x", "tool", "ew-resize");
                        });
                  },
                  ...
                  loadToolDefs: function() {
                     ...
                     var ToolDefs = AD.Model.get(
                        "opsportal.navedit.OPConfigToolDefinition"
                     );
                     ToolDefs.findAll({})
                        .fail(function(err) {
                           dfd.reject(err);
                     ...
                     if (!this.doResize) {
                        ...
                        setTimeout(function() {
                           if (!_this.data.resize) {
                              ...
                              _this.data.resize = {};
                              _this.data.resize.verticalSpacing = verticalAdjustments(
                                 _this.element.find(".op-navbar-lpanel")
                              );
                              _this.data.resize.heightMenu = _this.element
                                 .find(".op-navbar-area-menu")
                                 .outerHeight();
                           }
                           ...
                           if (_this.data.resize.heightMenu) {
                              var newHeight =
                                 _this.lastResize.height -
                                 _this.data.resize.heightMenu -
                                 _this.data.resize.verticalSpacing -
                                 2;
                              ...
                              _this.element
                                 .find(".op-navbar-lpanel")
                                 .css("height", _this.lastResize.height);
                           } else {
                     ...
                     this.dom.area.hide(
                        ...
                        function() {
                           ...
                           if (_this.events.lastArea) {
                              AD.comm.hub.publish(
                                 "opsportal.area.show",
                                 _this.events.lastArea
                              );
                           } else {
                              // choose the first menu item, and click it:
                              _this.element
                                 .find(".op-menu-widget li:first")
                                 .click();
                           }
