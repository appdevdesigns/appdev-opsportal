	...
	System.import('appdev').then(function() {
		steal.import('appdev/model/model').then(function() {
			...
			AD.Model.Base.extend("opstools.RBAC.PermissionScopeObject", {
				...
				describe: function() { return { 'name':'string', 'keyModel':'string' };  },
				...
				// model: function() {
				//     return AD.Model.get('opstools.RBAC.PermissionScopeObject'); //AD.models.opstools.RBAC.PermissionScopeObject;
				// },
				// getID: function() {
