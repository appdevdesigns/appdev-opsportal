	...
	System.import('appdev').then(function() {
		steal.import('appdev/model/model').then(function() {
			...
			AD.Model.Base.extend("opstools.RBAC.PermissionScope", {
				...
				describe: function() { return { 'label':'string', 'filter':'json', 'filterUI':'json', 'isGlobal':'boolean' };  },
				associations:{'permission':'opstools.RBAC.Permission', 'object':'opstools.RBAC.PermissionScopeObject', 'createdBy':'opstools.RBAC.SiteUser'}, 
