         ...
         steal.import("appdev/ad", "appdev/control/control").then(function() {
            ...
            AD.Control.extend("opstools.RBAC.Scopes", {
               init: function(element, options) {
                  ...
                  this.loadScopeObjects().then(function(list) {
                     _this.initDOM();
                  });
               },
               ...
               initDOM: function() {
                  ...
                  webix.ready(function() {
                     ...
                     ////
                     var lblPlaceholderSearch =
                        AD.lang.label.getLabel("rbac.scopes.search") ||
                        "Search *";
                     ...
                     _this.dom.searchScopes.AD.filter(function(value) {
                        ...
                        _this.dom.scopeGrid.filter(function(obj) {
                           ...
                           return (
                              (obj.label &&
                                 obj.label.toLowerCase().indexOf(value) >= 0) ||
                              (obj.description &&
                                 obj.description.toLowerCase().indexOf(value) >=
                                    0)
                           );
                        });
                     });
                     ...
                     ////
                     var lblHeaderName =
                        AD.lang.label.getLabel("rbac.roles.name") || "Name*";
                     var lblHeaderDescription =
                        AD.lang.label.getLabel("rbac.roles.description") ||
                        "Description*";
                     var lblHeaderObject =
                        AD.lang.label.getLabel("rbac.scopes.object") ||
                        "Object*";
                     _this.dom.scopeGrid = webix.ui({
                        ...
                        columns: [
                           {
                              id: "label",
                              header: lblHeaderName,
                              width: 180,
                              sort: "string"
                           },
                           {
                              id: "description",
                              header: lblHeaderDescription,
                              fillspace: true
                           },
                           {
                              id: "object",
                              header: lblHeaderObject,
                              width: 180,
                              sort: "string",
                              template: function(obj) {
                                 if (obj.object) {
                                    ...
                                    return (
                                       _this.data.hashScopeObjectNames[id] || id
                                    );
                                 }
                                 return "-";
                              }
                           },
                           {
                              ...
                              template: function(obj) {
                                 return (
                                    "<div class='clone fa fa-copy fa-2 offset-9 rbac-scope-list-clone' scope-id='" +
                                    obj.id +
                                    "'  ></div>"
                                 );
                              }
                        ...
                        pager: {
                           template:
                              "{common.prev()} {common.pages()} {common.next()}",
                        ...
                        onClick: {
                           clone: function(e, id) {
                              ...
                              var lblConfirmClone =
                                 AD.lang.label.getLabel(
                                    "rbac.scopes.confirmClone",
                                    [this.getItem(id).label]
                                 ) || "*Clone :" + this.getItem(id).label;
                              webix.confirm({
                                 text: lblConfirmClone,
                           ...
                           trash: function(e, id) {
                              ...
                              var lblConfirm =
                                 AD.lang.label.getLabel(
                                    "rbac.roles.confirmDelete",
                                    [this.getItem(id).role_label]
                                 ) || "Remove :" + this.getItem(id).role_label;
                              webix.confirm({
                                 text: lblConfirm,

                                 callback: function(result) {
                                    if (result) {
                                       _this.data.scopesCollection.AD.destroyModel(
                                          id
                                       )
                                          .fail(function(err) {
                                             AD.error.log(
                                                "Error destroying scope.",
                                                {
                                                   error: err,
                                                   model: scope,
                                                   id: id
                     ...
                     var labelLabel =
                        AD.lang.label.getLabel("rbac.roles.name") ||
                        "Scope Name*";
                     var placeHolderLabel =
                        AD.lang.label.getLabel(
                           "rbac.scopes.labelPlaceholder"
                        ) || "Enter a Name*";
                     var labelDesc =
                        AD.lang.label.getLabel("rbac.roles.description") ||
                        "Role Description*";
                     var placeHolderDesc =
                        AD.lang.label.getLabel(
                           "rbac.scopes.descriptionPlaceholder"
                        ) || "Scope Description*";
                     var labelObject =
                        AD.lang.label.getLabel("rbac.scopes.object") ||
                        "Object*";
                     var labelButtonSave =
                        AD.lang.label.getLabel("ab.common.save") || "Save*";
                     var labelButtonCancel =
                        AD.lang.label.getLabel("ab.common.cancel") || "Cancel*";
                        ...
                        elements: [
                           {
                              ...
                              rows: [
                                 ...
                                 {
                                    id: _this.uuid("form_description"),
                                    view: "textarea",
                                    name: "description",
                                    label: labelDesc,
                                    labelPosition: "top",
                                    ...
                                    cols: [
                                       ...
                                       },
                                       {
                                          ...
                                          click: function() {
                                             ...
                                             if (model) {
                                                var formValues = $$(
                                                   _this.uuid("formScope")
                                                ).getValues();

                                                formValues.filterUI = _this
                                                   .getQueryBuilderEL()
                     ...
                     _this.dom.formScope.elements.object.attachEvent(
                        "onChange",
                        function(newv, oldv) {
                           if (newv) {
                              var model = _this.data.scopesCollection.AD.currModel();
                                    ...
                                    AD.op.Dialog.Confirm({
                                       ...
                                       callback: function(result) {
                                          if (result) {
                                             ...
                                             model.object = newv;
                                             var el = _this.queryBuilderInit(
                                                model
                                             );
                                          } else {
                                             // change it back:
                                             $$(
                                                _this.uuid("form_object")
                                             ).setValue(oldv);
                                          }
                                       }
                                    });
                              ...
                              console.error(
                                 "HOW DID onChange fire with no newv ?"
                              );
                           }
                        }
                     );
               ...
               loadScopes: function(list) {
                  ...
                  this.data.scopesCollection.attachEvent(
                     "onAfterCursorChange",
                     function(id) {
               ...
               loadScopeObjects: function() {
                  ...
                  var ScopeObjects = AD.Model.get(
                     "opstools.RBAC.PermissionScopeObject"
                  );
                  return ScopeObjects.findAll()
                     .fail(function(err) {
                        AD.error.log(
                           "RBAC:Scopes.js: error loading ScopeObjects.",
                           { error: err }
                        );
                     })
                     .then(function(list) {
               ...
               queryBuilderInit: function(scope) {
                  ...
                  if (scope.object) {
                     ...
                     if (_this.data.hashScopeObjectFilters[objID]) {
                        ...
                        AD.comm.service
                           .get({
                              url: "/site/permission/scopeobject/:id/definition".replace(
                                 ":id",
                                 objID
                              )
                           })
                           ...
                           .done(function(result) {
                              ...
                              if (result.attributes) {
                                 for (var a in result.attributes) {
                                    filters.push(
                                       _this.queryBuilderAttributeToFilter(
                                          a,
                                          result.attributes[a],
                                          (result.filters &&
                                             result.filters[a]) ||
                              ...
                              _this.data.hashScopeObjectFilters[
                                 objID
                              ] = filters;
                              updateQB(filters);
                           });
               ...
               resize: function(data) {
                  if (this.dom.scopeGrid) {
                     ...
                     this.dom.searchScopes.define(
                        "width",
                        this.dom.scopeGrid.$width / 2
                     );
               ...
               scopeAdd: function() {
                  ...
                  attrs.label =
                     AD.lang.label.getLabel("rbac.scopes.newScope") ||
                     "New Scope*";
                  attrs.description =
                     AD.lang.label.getLabel(
                        "rbac.scopes.newScopeDescription"
                     ) || "*Describe this scope ...";
                  attrs.label += " (" + AD.util.uuid().substring(0, 4) + ")";

                  return this.scopeCreate(attrs).done(function(newModel) {
               ...
               scopeClone: function(id) {
                  ...
                  return this.scopeCreate(attrs).done(function(newScope) {
               ...
               scopeCreate: function(attrs) {
                  ...
                  Model.create(attrs)
                     .fail(function(err) {
                        AD.error.log("Error creating new scope.", {
                           error: err,
                           attrs: attrs
                        });
                        dfd.reject();
