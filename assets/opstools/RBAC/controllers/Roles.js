            ...
            .then(function() {
               ...
               AD.Control.extend("opstools.RBAC.Roles", {
                  ...
                  initDOM: function() {
                     ...
                     webix.ready(function() {
                        ...
                        var lblPlaceholderSearch =
                           AD.lang.label.getLabel("rbac.roles.search") ||
                           "Search *";
                        ...
                        _this.dom.roleSearch.AD.filter(function(value) {
                           ...
                           _this.dom.roleGrid.filter(function(obj) {
                              //here it filters data!
                              return (
                                 obj.role_label.toLowerCase().indexOf(value) >=
                                 0
                              );
                           });
                        });
                           ...
                           columns: [
                              ...
                              },
                              {
                                 ...
                                 template: function(obj) {
                                    return (
                                       "<div class='clone fa fa-copy fa-2 offset-9 rbac-role-list-clone' role-id='" +
                                       obj.id +
                                       "'  ></div>"
                                    );
                                 }
                           ...
                           onClick: {
                              clone: function(e, id) {
                                 ...
                                 var lblConfirmClone =
                                    AD.lang.label.getLabel(
                                       "rbac.roles.confirmClone",
                                       [this.getItem(id).role_label]
                                    ) ||
                                    "Clone :" + this.getItem(id).role_label;
                                 webix.confirm({
                              ...
                              trash: function(e, id) {
                                 ...
                                 webix.confirm({
                                    ...
                                    callback: function(result) {
                                       if (result) {
                                          _this.data.rolesCollection.AD.destroyModel(
                                             id
                                          )
                                             .fail(function(err) {
                                                AD.error.log(
                                                   "Error destroying role.",
                                                   {
                                                      error: err,
                                                      role: role,
                                                      id: id
                        ...
                        var placeHolderLabel =
                           AD.lang.label.getLabel("rbac.roles.label") ||
                           "Role Name*";
                        var labelDesc =
                           AD.lang.label.getLabel("rbac.roles.description") ||
                           "Role Description*";
                        var placeHolderDesc =
                           AD.lang.label.getLabel(
                              "rbac.roles.descriptionPlaceholder"
                           ) || "Role Description*";
                        ...
                        fields.forEach(function(field) {
                           _this.dom.formRole.elements[field].attachEvent(
                              "onChange",
                              function(newv, oldv) {
                        ...
                        ////
                        var lblPlaceholderSearchActions =
                           AD.lang.label.getLabel("rbac.roles.searchActions") ||
                           "Search Actions*";
                        ...
                        _this.dom.roleSearchActions.AD.filter(function(value) {
                           ...
                           _this.dom.actionGrid.filter(function(obj) {
                              return (
                                 obj.action_key.toLowerCase().indexOf(value) >=
                                 0
                              );
                           });
                        });
                           ...
                           on: {
                              ...
                              onAfterEditStop: function(
                                 ...
                                 if (state.value != state.old) {
                                    ...
                                    var action = _this.data.actionsCollection.AD.getModel(
                                       editor.row
                                    );
                                    ...
                                    action
                                       ...
                                       .fail(function(err) {
                                          AD.error.log(
                                             "RBAC:Roles:onAfterEditStop(): error updating action",
                                             {
                                                error: err,
                                                action: action.attr(),
                                                editor: editor
                  ...
                  actionChecked: function(id) {
                     ...
                     // get current action
                     var actionModel = this.data.actionsCollection.AD.getModel(
                        id
                     );
                     ...
                     return role.save().fail(function(err) {
                        AD.error.log(
                           "Roles:actionChecked(): error saving action to role:",
                           {
                              error: err,
                              action: action.attr(),
                              role: role.attr()
                  ...
                  actionUnChecked: function(id) {
                     ...
                     if (role.actions) {
                        role.actions.replace(
                           role.actions.filter(function(action) {
                              return action.id != id;
                           })
                        );
                     }
                     ...
                     return role.save().fail(function(err) {
                        AD.error.log(
                           "Roles:actionUnChecked(): error removing action from role:",
                           { error: err, id: id, role: role.attr() }
                        );
                     });
                  },
                  ...
                  loadActions: function() {
                     ...
                     var Actions = AD.Model.get(
                        "opstools.RBAC.PermissionAction"
                     );
                     Actions.findAll()
                        .fail(function(err) {
                           AD.error.log(
                              "RBAC:Roles.js: error loading actions.",
                              { error: err }
                           );
                        })
                        .then(function(list) {
                           ...
                           _this.data.actionsCollection = AD.op.WebixDataCollection(
                              list
                           );
                           if (_this.dom.actionGrid) {
                              _this.dom.actionGrid.data.sync(
                                 _this.data.actionsCollection
                              );
                           }
                        });
                  },
                  ...
                  loadRoles: function(list) {
                     ...
                     this.data.rolesCollection = AD.op.WebixDataCollection(
                        list
                     );
                  ...
                  resize: function() {
                     ...
                     this.dom.roleSearch.define(
                        "width",
                        this.dom.roleGrid.$width / 2
                     );
                     ...
                     this.dom.roleSearchActions.define(
                        "width",
                        this.dom.actionGrid.$width
                     );
                  ...
                  roleAdd: function() {
                     ...
                     attrs.role_label =
                        AD.lang.label.getLabel("rbac.roles.newRole") ||
                        "New Role";
                     attrs.role_description =
                        AD.lang.label.getLabel(
                           "rbac.roles.newRoleDescription"
                        ) || "Describe this role ...";
                     attrs.role_label +=
                        " (" + AD.util.uuid().substring(0, 4) + ")";

                     return this.roleCreate(attrs).done(function(newRole) {
                  ...
                  roleCreate: function(attrs) {
                     ...
                     Roles.create(attrs)
                        .fail(function(err) {
                           AD.error.log("Error creating new role.", {
                              error: err,
                              attrs: attrs
                           });
                           dfd.reject();
