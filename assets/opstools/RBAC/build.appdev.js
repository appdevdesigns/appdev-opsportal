      ...
      async.series(
         [
            ...
            function(next) {
               ...
               transform(
                  ...
                  .then(function(transform) {
                     ...
                     fs.writeFile(
                        path.join("opstools", "RBAC", "production.js"),
                        main.code,
                        "utf8",
                        function(err) {
                           if (err) {
                              AD.log.error(
                                 "<red>could not write minified JS file !</red>",
                                 err
                              );
                              next(err);
                           }
                  ...
                  .catch(function(err) {
                     AD.log.error(
                        "<red>could not complete opstools/RBAC JS build!</red>",
                        err
                     );
                     next(err);
                  });
            ...
            function(next) {
               ...
               var patches = [
                  {
                     file: path.join("opstools", "RBAC", "production.js"),
                     tag: "packages/OpsPortal-RBAC.js",
