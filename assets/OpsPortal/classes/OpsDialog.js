      ...
      AD.op.Dialog = {
         ...
         Alert: function(opts) {
            webix.alert({
               title:
                  opts.title ||
                  AD.lang.label.getLabel("opp.dialog.alert.title") ||
                  "*Alert",
               text:
                  opts.text ||
                  opts.message ||
                  AD.lang.label.getLabel("opp.dialog.alert.text") ||
                  "*Something is wrong.",
               ok:
                  opts.ok ||
                  AD.lang.label.getLabel("opp.dialog.alert.ok") ||
                  "*OK"
            });
         },
         ...
         Confirm: function(opts) {
            var title =
               opts.title ||
               AD.lang.label.getLabel("opp.dialog.confirm.confirmTitle") ||
               "* Confirm";
            var message =
               opts.text ||
               opts.message ||
               AD.lang.label.getLabel("opp.dialog.confirm.confirmMsg") ||
               "* Are you sure you want to do this?";

            var labelYes =
               opts.labelYes ||
               opts.ok ||
               AD.lang.label.getLabel("opp.common.yes") ||
               "* yes";
            var labelNo =
               opts.labelNo ||
               opts.cancel ||
               AD.lang.label.getLabel("opp.common.no") ||
               "* no";
         ...
         ConfirmDelete: function(opts) {
            AD.op.Dialog.Confirm({
               title:
                  opts.title ||
                  AD.lang.label.getLabel("opp.dialog.confirm.deleteTitle") ||
                  "* Confirm Delete",
               ok:
                  opts.ok ||
                  AD.lang.label.getLabel("opp.common.delete") ||
                  "* Delete",
               cancel:
                  opts.cancel ||
                  AD.lang.label.getLabel("opp.common.cancel") ||
                  "* Cancel",
               text:
                  opts.text ||
                  opts.message ||
                  AD.lang.label.getLabel("opp.dialog.confirm.deleteMsg", [
                     "this"
                  ]) ||
