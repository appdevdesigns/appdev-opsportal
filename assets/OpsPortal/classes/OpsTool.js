System.import("can").then(function() {
   steal
      .import("appdev/ad", "appdev/control/control", "appdev/comm/socket")
      .then(function() {
         // Namespacing conventions:
         // AD.classes.[application].[Class]  --> Object
         if (typeof AD.classes.opsportal == "undefined")
            AD.classes.opsportal = {};
         ...
         if (typeof AD.Control.OpsTool == "undefined") {
            AD.Control.OpsTool = {
               ...
               extend: function(name, staticDef, instanceDef) {
                  ...
                  curr.Tool = AD.classes.opsportal.OpsTool.extend(
                     staticDef,
                     instanceDef
                  );
