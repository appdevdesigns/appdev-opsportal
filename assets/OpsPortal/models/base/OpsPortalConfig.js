System.import("appdev").then(function() {
   steal.import("jquery", "appdev/ad", "appdev/model/model").then(function() {
      AD.Model.Base.extend(
         ...
         },
         {
            ...
            getID: function() {
               return (
                  this.attr(AD.models.OpsPortalConfig.fieldId) ||
                  "unknown id field"
               );
            },
            getLabel: function() {
               return (
                  this.attr(AD.models.OpsPortalConfig.fieldLabel) ||
                  "unknown label field"
               );
            }
         }
