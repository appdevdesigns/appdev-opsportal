module.exports = {
   map: {
      ...
      selectivity: "js/selectivity/selectivity.min",
      "selectivity.css": "js/selectivity/selectivity.min.css",
   ...
   paths: {
      ...
      "bootstrap.css": "js/bootstrap/css/bootstrap.min.css",
      "bootstrap-datetimepicker":
         "js/bootstrap/ext/bootstrap-datetimepicker.min.js",
      "bootstrap-datetimepicker.css": "styles/bootstrap-datetimepicker.min.css",
   ...
   meta: {
      ...
      "feedback/feedback.min": {
         deps: ["js/jquery.min", "feedback/feedback.min.css"],
         format: "global",
         sideBundle: true
      },
      "js/jquery-ui.min": {
      ...
      "js/query-builder.standalone.min": {
         deps: ["styles/query-builder.default.min.css", "jquery"],
         format: "global",
         sideBundle: true
      },
      "js/moment.min": {
      ...
      "js/bootstraptable/bootstrap-table": {
         deps: [
            ...
            "js/bootstraptable/bootstrap-table.css"
         ],
         format: "global",
         sideBundle: true
      },
      ...
      "js/webix/components/pivot/pivot": {
         deps: ["js/webix/webix", "js/webix/components/pivot/pivot.css"],
         format: "global",
         sideBundle: true
      },
      ...
      "js/webix/components/kanban/kanban.min": {
         deps: ["js/webix/webix", "js/webix/components/kanban/kanban.min.css"],
         format: "global",
         sideBundle: true
      },
      ...
      "js/webix/webix": {
         deps: ["js/webix/skins/material.min.css"],
         format: "global",
         sideBundle: true
      },
