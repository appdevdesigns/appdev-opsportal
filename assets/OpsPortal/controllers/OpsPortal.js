            ...
            steal
                ...
                .then(function() {
                    ...
                    if (typeof Dropzone !== "undefined") {
                        Dropzone.prototype.detectVerticalSquash = function(
                            img
                        ) {
                            var alpha,
                                canvas,
                    ...
                    AD.Control.extend("OpsPortal.OpsPortal", {
                            ...
                            this.options = AD.defaults(
                                {
                                    ...
                                    templateList:
                                        "/OpsPortal/views/OpsPortal/taskList.ejs",
                                    templateError:
                                        "/OpsPortal/views/OpsPortal/error.ejs"
                                },
                                options
                            );
                        ...
                        initDOM: function() {
                            this.element.html(
                                can.view(this.options.templateList, {})
                            );
                        ...
                        initPortal: function() {
                            ...
                            this.portalPopup.html(
                                can.view(this.options.templateDOM, {
                                    baseURL:
                                        AD.config.getValue("siteBaseURL") || ""
                                })
                            );
                            ...
                            $("#userprofile-menuitem").on("click", function(
                                ev
                            ) {
                                ev.preventDefault();
                                        ...
                                        return ABApplication.allCurrentApplications()
                                            .then((dcList) => {
                                                ...
                                                allApps.forEach((app) => {
                                                    ...
                                                    $$(
                                                        "inbox_accordion"
                                                    ).addView(appAccordion);
                                                    app.processes().forEach(
                                                        (p) => {
                                                            processLookupHash[
                                                                p.id
                                                            ] = `${p.label}`;
                        ...
                        initFeedback: function() {
                            ...
                            for (var key in templates) {
                                ...
                                // plaintext string.
                                templates[key] =
                                    templates[key].firstChild.innerHTML;
                            }
                        ...
                        resize: function() {
                            ...
                            var hMasthead = this.dom.resize.masthead.outerHeight(
                                true
                            );
                            console.log(
                                ...
                                setTimeout(function() {
                                    ...
                                    AD.comm.service
                                        ...
                                        .then(function(newConfig) {
                                            ...
                                            recurseAreas(newAreas, function(
                                                err
                                            ) {
                                                if (err) {
                                                    // ???
                        ...
                        ".op-masthead a:first-of-type click": function(
                            $el,
                            ev
                        ) {
