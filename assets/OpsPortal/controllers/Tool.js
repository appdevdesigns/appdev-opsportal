            ...
            .then(function() {
               ...
               AD.Control.extend("OpsPortal.Tool", {
                  init: function(element, options) {
                           ...
                           if (AD.controllers.opstools[name]) {
                              if (AD.controllers.opstools[name].Tool) {
                                 ...
                                 console.warn(
                                    "controller (" +
                                       name +
                                       ").Tool()   not found! ... waiting to try again"
                                 );
                                 setTimeout(function() {
                              ...
                              console.warn(
                                 "controller (" +
                                    name +
                                    ") not found!  ... waiting to try again"
                              );
                              setTimeout(function() {
                                 delayedLoad(name, count + 1);
                              }, 100);
                     ...
                     AD.comm.hub.subscribe("opsportal.resize", function(
                        message,
                        data
                     ) {
                        self.sizeData = data;
                        ...
                        // and if I'm active
                        if (self.isAreaActive && self.isActive) {
                     ...
                     AD.comm.hub.subscribe("opsportal.tool.show", function(
                        message,
                        data
                     ) {
                        self.toolShow(data);
