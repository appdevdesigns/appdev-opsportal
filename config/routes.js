...
module.exports = {
   ...
   "get /opsportal/socket/register":
      "appdev-opsportal/OpsPortalController.registerSocket",
   ...
   "get  /opsportal/image/:appKey/:uuid":
      "appdev-opsportal/OPImageUploadController.read",
   "get  /opsportal/imageBase64/:appKey/:uuid":
      "appdev-opsportal/OPImageUploadController.readBase64",
   "post /opsportal/image": "appdev-opsportal/OPImageUploadController.create",
   "post /opsportal/imageBase64":
      "appdev-opsportal/OPImageUploadController.createBase64",
   "post /opsportal/image/:appKey/:permission/:isWebix":
      "appdev-opsportal/OPImageUploadController.create",

   // OpsPortal File Uploader
   "get  /opsportal/file/:appKey/:uuid":
      "appdev-opsportal/OPFileUploadController.read",
   "post /opsportal/file": "appdev-opsportal/OPFileUploadController.create",
   "post /opsportal/file/:appKey/:permission/:isWebix":
      "appdev-opsportal/OPFileUploadController.create"
};
